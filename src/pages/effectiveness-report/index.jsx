...
function EffectReport() {
  ...
  const {
    ...
    onSubmit: (values, { setSubmitting }) => {
      ...
      axios.post(
        baseURL+'/package/',values,{headers:headers}
      ).then(res=>{
        console.log(res)
  ...
  const handleEdit = (e) => {
    ...
    setId(value);
    axios.get(
      baseURL+`/package/${value}/`,values,{headers:headers}
    )
    .then(res=>{
      console.log(res)
      onOpen();
  ...
  const handleUpdate = (e) => {
    e.preventDefault();
    axios.patch(
      baseURL+`/package/${id}/`,values,{headers:headers}
    )
    .then(res=>{
      console.log(res)
      getPackage().then(res=>setPackages(res))
  ...
  const handleDelete = (e) => {
    ...
    axios.delete(
      baseURL+`/package/${value}/`,{headers:headers}
    )
    .then(res=>{
      console.log(res)
      getPackage().then(res=>setPackages(res))
