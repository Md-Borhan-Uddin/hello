...
export const registrationSchima = Yup.object({
    ...
    username: Yup.string().min(6, "Minimum 6 Character").max(20, "Maximum 20 Character").required('Enter username'),
...
export const propertyAddSchima = Yup.object({
  ...
  property_age_years: Yup.string().max(3, "Max Length 3 Character").required("Must Fill This Field"),
  ...
  cost_currency: Yup.string().optional(),
  cost_date: Yup.date(),
  purpose: Yup.string().required("Must Fill This Field"),
  number_of_floors: Yup.string().max(2, "Max Length 2 digit").required("Must Fill This Field"),
...
export const propertyEditSchima = Yup.object({
  ...
  property_age_years: Yup.string().max(3, "Max Length 3 Character").required("Must Fill This Field"),
  property_age_months: Yup.number().optional(),
  authorized: Yup.string().required("Must Fill This Field"),
  purchasing_cost: Yup.number().required("Must Fill This Field"),
  cost_currency: Yup.string().optional(),
  cost_date: Yup.date(),
  purpose: Yup.string().required("Must Fill This Field"),
